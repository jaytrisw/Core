...
class PersistentPreferencesUserDefaults {
    ...
    static var `default`: PersistentPreferencesUserDefaults {
        return PersistentPreferencesUserDefaults(
            userDefaults: UserDefaults.standard)
    }
}

extension PersistentPreferencesUserDefaults: PersistentPreferences {
...
class PersistentPreferencesInMemory {
    
    private var storage: [Core.Key: Any]
    
    public init(storage: [Core.Key: Any] = [:]) {
        self.storage = storage
    }
    
}

extension PersistentPreferencesInMemory: PersistentPreferences {
